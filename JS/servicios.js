function showService(service) {
    const content = {
        fotografia: `
            <h2>Fotografía</h2>
            <img src="images/fotografia.png" alt="Fotografía" width="50">
        ...
        pintura: `
            ...
            <img src="imagenes/pintura.jpg" alt="Pintura" width="50">
        `,
        idea: `
            <h2>Crea tu Idea</h2>
        ...
        escultura: `
            ...
            <img src="images/artesanias1.png" alt="Escultura" width="30">
        `,
        portadas: `
